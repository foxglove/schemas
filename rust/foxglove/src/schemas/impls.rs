...
impl Encode for CameraCalibration {
    ...
    fn encoded_len(&self) -> Option<usize> {
        Some(::prost::Message::encoded_len(self))
    }
}
...
impl Encode for Grid {
    ...
    fn get_schema() -> Option<Schema> {
        Some(Schema::new("foxglove.Grid", "protobuf", descriptors::GRID))
    }
...
impl Encode for Log {
    ...
    fn get_schema() -> Option<Schema> {
        Some(Schema::new("foxglove.Log", "protobuf", descriptors::LOG))
    }
...
impl Encode for Pose {
    ...
    fn get_schema() -> Option<Schema> {
        Some(Schema::new("foxglove.Pose", "protobuf", descriptors::POSE))
    }
