...
use foxglove_sdk_core::websocket::{create_server, Server, ServerOptions};
use foxglove_sdk_core::{FoxgloveError, LogContext, LogSink};

/// A websocket server for live vizualization.
#[must_use]
#[derive(Debug)]
...
impl Debug for WebSocketServerHandle {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_tuple("WebSocketServerHandle")
